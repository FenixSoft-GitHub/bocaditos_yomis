...
//   address_1: z.string().min(5, "Ingresa tu dirección completa"),
...
//   full_name: z.string().min(3, "Ingresa el nombre del destinatario"),
//   phone: z.string().min(7, "Ingresa un teléfono de contacto"),
//   delivery_option_id: z.string().min(1, "Selecciona un método de envío"),
...
// interface Props {
//   onOrderCreated: (payload: CreateOrderPayload) => void;
//   loading: boolean;
//   error: string | null;
// }
...
//       // 2. Guardar la dirección en Supabase y obtener su ID
//       const { data: address, error: addressError } = await supabase
//         .from("addresses")
//         .insert({
//           user_id: user.id,
...
//       // 3. Construir el payload para la Edge Function
...
//       // 4. Llamar a create-order via Edge Function
//       onOrderCreated(payload);
//     } catch (err: any) {
//       console.error("[FormCheckout]", err);
//     }
//   });
...
//               <label className="text-sm text-choco/60 dark:text-cream/60">
...
//               />
//               {errors.address_1 && (
//                 <FieldError msg={errors.address_1.message!} />
//               )}
//             </div>
...
//             <div className="col-span-2 space-y-1">
//               <label className="text-sm text-choco/60 dark:text-cream/60">
//                 Apartamento, piso, referencia (opcional)
//               </label>
//               <input
//                 {...register("address_2")}
//                 autoComplete="address-line2"
...
//               <label
//                 key={option.id}
//                 className="flex items-center gap-3 p-4 rounded-xl border border-cocoa/20 dark:border-cream/10 cursor-pointer hover:border-cocoa/50 dark:hover:border-cream/30 transition-colors has-[:checked]:border-cocoa has-[:checked]:bg-cocoa/5"
//               >
//                 <input
//                   type="radio"
//                   value={option.id}
...
//           </div>
//           {errors.delivery_option_id && (
//             <FieldError msg={errors.delivery_option_id.message!} />
//           )}
//         </section>
...
//           </h3>
//           <div className="space-y-2">
//             <label className="flex items-center gap-3 p-4 rounded-xl border border-cocoa/20 dark:border-cream/10 cursor-pointer hover:border-cocoa/50 dark:hover:border-cream/30 transition-colors has-[:checked]:border-cocoa has-[:checked]:bg-cocoa/5">
//               <input
//                 type="radio"
//                 value="pago_movil"
//                 {...register("payment_type")}
...
//           </div>
//           {errors.payment_type && (
//             <FieldError msg={errors.payment_type.message!} />
//           )}
//         </section>
...
//   <p className="text-red-400 text-xs mt-0.5">{msg}</p>
// );
