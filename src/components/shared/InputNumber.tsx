...
export default function InputNumber({
  ...
  return (
    <div
      className={`group flex justify-between items-stretch rounded-md font-semibold ring ring-cocoa/90 transition-[box-shadow] focus-within:ring-2 focus-within:ring-amber-500 dark:ring-cream/50 ${className}`}
    >
      <button
        aria-hidden="true"
        tabIndex={-1}
